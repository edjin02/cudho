  ...
  <!-- Main Sidebar Container -->
    <aside class="main-sidebar sidebar-light-primary elevation-2">
        ...
        <div class="logo" style="background-color: maroon; height: 56px;">
            <a href="navigator.php" class="brand-link">
            <img src="../../adminLTE/AdminLTE-3.2.0/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-2" style="opacity: .8;">
        ...
        <!-- /.col -->
        <a class="nav-item" role="text"><i class="fas fa-home"></i></a>
        <a href="index3.html" class="nav-item">Home Page</a>
        ...
        <strong>Copyright © 2023 <a href="">Property of Municipality of Santa Rosa Laguna</a>.</strong>
        All rights reserved.
