...
$query = "SELECT * FROM tbl_verif WHERE id = $id";
...
<?php // for spouse info
require '../include/connect.php'; //$con
$query = "SELECT * FROM tbl_faminfo WHERE for_id = $id AND relationship = 'spouse'";
$result = $con->query($query);
...
// require '../include/connect.php'; //$con
// $query = "SELECT * FROM tbl_faminfo WHERE for_id = $id";
// $result = $con->query($query);
...
// $tbl_faminfo = array(array(1,2,3),array(4,5,6));

// list($id, $for_id, $firstname) = $tbl_faminfo[1];
