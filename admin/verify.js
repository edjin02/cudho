    ...
    for (let i = 1; i <= numSenior; i++) {
        const seniorField = `
            ...
            <div class="input-group">
                ...
                <div class="col-md-3 mb-3">
                    <input type="checkbox" value="checked" name="seniorBox_${i}" id="seniorBox_${i}">
                    <label for="seniorBox_${i}" style="margin-top:6px;">Senior Citizen</label>
                </div>
                <div class="col-md-3 mb-3">
                    <input type="checkbox" value="checked" name="pwdBox_${i}" id="pwdBox_${i}">
        ...
        <div class = "row">
            ...
            <div class="col-md-4 mb-2">
                <div class="Wother-textbox-container">
                    <input type="text" class="input-border form-control" name="Wchild_other_${i}" id="Wchild_other_${i}" placeholder="Other(Optional)">
                </div>
            </div>
            </div>
        `;
