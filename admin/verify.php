<?php 
    ...
    include 'option.php';
    include '../verifcomponent/Functions.php';
?>
<script src="../verifcomponent/verify-script.js"></script>
<script src="../verifcomponent/jQuerySQL.js"></script>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="../include/addmember_inc.php" method="post">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <input type="text" name="tag" size="2"
                                                            style="margin-right:10px; height:30px;" placeholder="Tag">
                                                        <input type="text" name="samahan" size="50"
                                                            style="margin-right:10px;height:30px;"
                                                            placeholder="Community/Samahan">

                                                        <div class="form-group" style="width:225px;">
                                                            <select name="barangay_select"
                                                                class="select2 select2-hidden-accessible"
                                                                style="width: 100%; height: 30px;" data-select2-id="3"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <input type="text" name="extension" size="8"
                                                            style="margin-right:10px; height: 30px;"
                                                            placeholder="Sr. Jr. II III">
                                                        <div class="form-group" style="width:115px;">
                                                            <select name="masterlist_select"
                                                                class="select2 select2-hidden-accessible"
                                                                style="width: 100%; height: 30px;" data-select2-id="3"
                                                                tabindex="-1" aria-hidden="true">
                                                                <option value="" selected="" data-select2-id="0">
                                                                </option>
                                                                <option value="Listed" data-select2-id="1">Listed
                                                                </option>
                                                                <option value="Not Listed" data-select2-id="2">Not
                                                                    Listed</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group" style="width:90px; margin-right:10px;">
                                                            <select name="gender_select"
                                                                ...
                                                                <option value="Female" data-select2-id="2">Female
                                                                </option>
                                                            </select>
                                                        </div>
                                                        <div class="input-group mb-3"
                                                            style="width:140px; margin-right:10px;">
                                                            <input type="date" name="birthdate_select"
                                                        ...
                                                        <div class="form-group" style="width:115px; margin-right:10px;">
                                                            <select name="civil_status"
                                                                ...
                                                                style="width: 100%; height: 30px;" data-select2-id="3"
                                                                tabindex="-1" aria-hidden="true">
                                                                <option value="Single" selected="" data-select2-id="0">
                                                                    Single</option>
                                                                <option value="Married" data-select2-id="1">Married
                                                                </option>
                                                                <option value="Divorced" data-select2-id="2">Divorced
                                                                </option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <input type="text" name="monthly_income" size="12"
                                                            style="height: 30px;" placeholder="Income">
                                                    </div>
                                                    ...
                                                    <div class="row" style="margin-top:-15px;">
                                                        <input type="checkbox" id="pagibigCheckbox" name="myCheckbox"
                                                            value="checked" style="margin-right:5px;">
                                                        <label for="pagibigCheckbox"
                                                            style="margin-top:6px; margin-right:30px;">PAGIBIG/HDMF</label>

                                                        <input type="checkbox" id="sssCheckbox" name="myCheckbox"
                                                            value="checked" style="margin-right:5px;">
                                                        <label for="sssCheckbox"
                                                            style="margin-top:6px; margin-right:30px;">SSS/GSIS</label>

                                                        <input type="checkbox" id="othersCheckbox" name="myCheckbox"
                                                            value="checked" style="margin-right:5px;">
                                                        <label for="othersCheckbox"
                                                            style="margin-top:6px; margin-right:30px;">OTHERS</label>
                                                    </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-warning mr-auto btn-sm"
                                                data-dismiss="modal" style="margin-left:10px;">Close</button>
