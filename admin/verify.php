    ...
    <div class="modal-body">
        <div class="card" style="border: 2px solid maroon;">
            ...
            <div class="form-row">
                ...
                <div class="input-group">
                    <input type="date" class="input-border form-control" name="head_birthDate" id="head_birthDate"
                ...
                <div class="input-group">
                    <input type="number" class="input-border form-control" name="head_monthSalary" id="head_monthSalary"
                ...
                <div class="input-group">
                    <input type="date" class="input-border form-control" name="spouse_birthDate" id="spouse_birthDate"
                     placeholder="Birthdate" required>
                </div>
                </div>
                <div class="col-md-4 mb-3">
                ...
                <div class="input-group">
                    <input type="number" class="input-border form-control" name="spouse_monthSalary" id="spouse_monthSalary"
                    placeholder="Monthly Salary" required>
                </div>
                </div>
                ...
                <div class="col-md-12 mb">
                    <div class="row">
                        ...
                        <div class="col-md-1 input-group"> <!-- Adjust the "col-md-2" to your desired width -->
                            <input type="number" class="input-border form-control" style="height: 25px; margin-left: -180px; margin-right: 200px" name="num_children" id="num_children" value = "0" placeholder="No." required min="0" max="50" oninput="generateChildFields()" >
                        </div>
                    </div>
                </div>
...
<!-- Minor Children field COdes
                ...
                <div class="col-md-12 mb">
                    <div class="row">
                        ...
                        <div class="col-md-1 input-group"> <!-- Adjust the "col-md-2" to your desired width -->
                            <input type="number" class="input-border form-control" style="height: 25px; margin-left: -130px; margin-right: 150px" name="num_workChildren" id="num_workChildren" value="0" placeholder="No." required min="0" max="50" oninput="generateWorkChildFields()">
                        </div>
                    </div>
                </div>
...
<!--  working child field codes
                ...
                <div class="row">
                    ...
                    <div class="col-md-1 input-group">
                        <input type="number" class="input-border form-control" style="height: 25px; margin-left: -220px; margin-right: 240px" name="num_senior" id="num_senior" value="0" placeholder="No." required min="0" max="50" oninput="generateSeniorFields()">
                    </div>
                </div>
                </div>
