<?php 
    ...
    include 'option.php';
    include '../memberviewcomponent/memberview_phps.php';
    // include '../memberviewcomponent/Functions.php';
    
?>

<!-- <script src="../memberviewcomponent/jQuerySQL.js"></script> -->
            ...
            <div class="col-md-4">
                    ...
                    <div class="card-footer" style ="padding-top: 10px;">
                        <div class="card-body table-responsive" style="padding: 1px">
                            ...
                            <tbody id="famTable">
                                <?php 
                                include '../include/get_family_info.php';
                                ?>
                    ...
                    <div class="card-footer" style ="padding-top: 10px;">
                        <div class="card-body table-responsive" style="padding: 1px">
                            ...
                            <?php 
                                include '../include/get_response_info.php';
                                ?>
