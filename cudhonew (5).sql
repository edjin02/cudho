...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2023 at 05:33 AM
...
(1, 1, 1, 'IANN', 'BAUANN', 'ENGOTT', '', 'MALE', '2011-12-29'),
(4, 1, 1, 'ANGEL', 'BAUAN', 'TANGA', '', 'FEMALE', '2010-05-01'),
(13, 1, 1, 'AMY', 'BAUAN', 'PASCUAL', '', 'MALE', '2022-01-13');
...
INSERT INTO `tbl_childwork` (`id`, `user_id`, `head_id`, `firstname`, `middlename`, `lastname`, `monthIncome`) VALUES
(1, 1, 1, 'ALAN', 'BAUAN', 'PASQUAL', 1000),
(2, 1, 1, 'TIN', 'PASCUAL', 'ROMERO', 200);
...
(1, 1, 1, 'OWN', 'LAGUNA WATERS', 'OWN', 'SHARED'),
...
(1, 1, 'DOMINIC', 'PASCUAL', 'BAUAN', 'MAIDEN', 'EXTEND', 'TAGAPO', 'JORDAN1', '1A', '1990-12-28', 'MALE', 'MARRIED', 'DANCER', 1000000, 'PAG-IBIG', 'OWNER', 'CONCRETE', '2019', '50', 'BALIK PROBINSYA PROG', 'SUVB. MERCEDES SINALHAN'),
(2, 1, 'JONATHAN', 'EVANGELIO', 'UTANE', 'GIRL', 'JR', 'TAGAPO', 'JORDAN1', '1A', '1985-11-11', 'MALE', 'SINGLE', 'PUSHER', 1000000, 'PAG-IBIG', 'OWNER', 'CONCRETE', '2000', '23', 'BALIK PROBISNYA PROG', 'SUVB. MERCEDES SINALHAN');
...
(1, 1, 1, 'KAYE ', 'KAMILLE', 'BAUTISTAA', '', '', 'MALE', 'SPOUSE', 'JOMARI', 'ALBION', 'GALANG', '2027-01-01', 'SI DOMINIC MAHILIG SA IMMERSION'),
(2, 1, 2, '', '', '', '', '', '', '', '', '', '', '0000-00-00', '');
